...
export class Binding {
     ...
     */
    resolve(parameterStore: any, expressionParser: any = null): number {
...
export class LiteralBinding extends Binding {
    ...
    toJSON(): { type: string; value: number } {
        return {
            type: this.type,
            value: this.value
        };
...
export class ParameterBinding extends Binding {
    ...
    toJSON(): { type: string; parameterId: string } {
        return {
            type: this.type,
...
export class ExpressionBinding extends Binding {
    expression: string;
    /** Lazily-populated AST produced by ExpressionParser.parse on the first resolve() call. */
    _cachedAST: any;
     ...
     */
    toJSON(): { type: string; expression: string } {
        return {
            type: this.type,
